...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:dn,depthTest:!1,depthWrite:!1})}function Ra(){return new Wt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ks(),fragmentShader:`
		...
		`,blending:dn,depthTest:!1,depthWrite:!1})}function wa(){return new Wt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ks(),fragmentShader:`
...
#define LOW_PRECISION`),e}function cd(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===qa?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Lo?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===jt&&(e="SHADOWMAP_TYPE_VSM"),e}function ud(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Qn:case ei:e="ENVMAP_TYPE_CUBE";break;case sr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function hd(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ei:e="ENVMAP_MODE_REFRACTION";break}return e}function fd(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ya:e="ENVMAP_BLENDING_MULTIPLY";break;case jo:e="ENVMAP_BLENDING_MIX";break;case Jo:e="ENVMAP_BLENDING_ADD";break}return e}function dd(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function pd(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=cd(t),c=ud(t),h=hd(t),f=fd(t),d=dd(t),m=td(t),v=nd(s),x=r.createProgram();let p,u,b=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            `,vertexColors:!0,transparent:!0,blending:tr,depthWrite:!1,fog:!0}),this.points=new $l(this.geometry,this.material)}update(e,t){const n=this.geometry.attributes.position.array,r=this.geometry.attributes.size.array,s=this.geometry.attributes.alpha.array,a=this.geometry.attributes.lifespan.array,o=this.geometry.attributes.color.array;for(let l=0;l<n.length/3;l++)if(a[l]>0&&(a[l]-=e),l<this.#e){if(n[l*3+2]+=e*t,n[l*3+2]>this.spread/2&&(n[l*3+2]=-this.spread/2),Math.random()>.2){const h=this.#e+this.#n;n[h*3]=n[l*3],n[h*3+1]=n[l*3+1],n[h*3+2]=n[l*3+2],o[h*3]=o[l*3],o[h*3+1]=o[l*3+1],o[h*3+2]=o[l*3+2],a[h]=1+Math.random(),r[h]=r[l]*.8,s[h]=1,this.#n=(this.#n+1)%(this.#e*this.#t)}}else a[l]>0?(s[l]=a[l]/2,r[l]*=.98):(s[l]=0,r[l]=0);this.geometry.attributes.position.needsUpdate=!0,this.geometry.attributes.size.needsUpdate=!0,this.geometry.attributes.alpha.needsUpdate=!0,this.geometry.attributes.lifespan.needsUpdate=!0,this.geometry.attributes.color.needsUpdate=!0}#i(){const e=document.createElement("canvas");e.width=e.height=64;const t=e.getContext("2d"),n=t.createRadialGradient(32,32,0,32,32,32);return n.addColorStop(0,"white"),n.addColorStop(.2,"white"),n.addColorStop(.4,"rgba(255,255,255,0.5)"),n.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=n,t.fillRect(0,0,64,64),new jl(e)}}const{lerp:yn}=xl,mt=[151,160,137,91,90,15,131,13,201,95,96,53,194,233,7,225,140,36,103,30,69,142,8,99,37,240,21,10,23,190,6,148,247,120,234,75,0,26,197,62,94,252,219,203,117,35,11,32,57,177,33,88,237,149,56,87,174,20,125,136,171,168,68,175,74,165,71,134,139,48,27,166,77,146,158,231,83,111,229,122,60,211,133,230,220,105,92,41,55,46,245,40,244,102,143,54,65,25,63,161,1,216,80,73,209,76,132,187,208,89,18,169,200,196,135,130,116,188,159,86,164,100,109,198,173,186,3,64,52,217,226,250,124,123,5,202,38,147,118,126,255,82,85,212,207,206,59,227,47,16,58,17,182,189,28,42,223,183,170,213,119,248,152,2,44,154,163,70,221,153,101,155,167,43,172,9,129,22,39,253,19,98,108,110,79,113,224,232,178,185,112,104,218,246,97,228,251,34,242,193,238,210,144,12,191,179,162,241,81,51,145,235,249,14,239,107,49,192,214,31,181,199,106,157,184,84,204,176,115,121,50,45,127,4,150,254,138,236,205,93,222,114,67,29,24,72,243,141,128,195,78,66,215,61,156,180];for(let i=0;i<256;i++)mt[256+i]=mt[i];function Vr(i){return i*i*i*(i*(i*6-15)+10)}function hn(i,e,t,n){const r=i&15,s=r<8?e:t,a=r<4?t:r==12||r==14?e:n;return((r&1)==0?s:-s)+((r&2)==0?a:-a)}class Wd{noise(e,t,n){const r=Math.floor(e),s=Math.floor(t),a=Math.floor(n),o=r&255,l=s&255,c=a&255;e-=r,t-=s,n-=a;const h=e-1,f=t-1,d=n-1,m=Vr(e),v=Vr(t),x=Vr(n),p=mt[o]+l,u=mt[p]+c,b=mt[p+1]+c,A=mt[o+1]+l,T=mt[A]+c,P=mt[A+1]+c;return yn(yn(yn(hn(mt[u],e,t,n),hn(mt[T],h,t,n),m),yn(hn(mt[b],e,f,n),hn(mt[P],h,f,n),m),v),yn(yn(hn(mt[u+1],e,t,d),hn(mt[T+1],h,t,d),m),yn(hn(mt[b+1],e,f,d),hn(mt[P+1],h,f,d),m),v),x)}}class Ws{#e=4;#t;mesh;spread;geoScale;constructor(e,t,n,r,s,a,o=.05){this.#t=Math.random()*360,this.spread=t,this.geoScale=e;const l=128,c=new Uint8Array(l*l*l);let h=0;const f=new Wd,d=new F;for(let p=0;p<l;p++)for(let u=0;u<l;u++)for(let b=0;b<l;b++){const A=1-d.set(b,u,p).subScalar(l/2).divideScalar(l).length();c[h]=(128+128*f.noise(b*o/1.5,u*o,p*o/1.5))*A*A,h++}const m=new so(c,l,l,l);m.format=Os,m.minFilter=Ut,m.magFilter=Ut,m.unpackAlignment=1,m.needsUpdate=!0;const v=new ri(1,1,1),x=new Wt({glslVersion:Cs,uniforms:{base:{value:new Be(7965344)},map:{value:m},cameraPos:{value:new F},threshold:{value:.25},opacity:{value:.25},range:{value:.1},steps:{value:100},frame:{value:0},fogColor:{value:new Be},fogNear:{value:0},fogFar:{value:1}},vertexShader:Xd,fragmentShader:qd,side:xt,blending:tr,transparent:!0,depthWrite:!1,fog:!0});this.mesh=new kt(v,x),x.uniforms.threshold.value=n,x.uniforms.opacity.value=r,x.uniforms.range.value=s,x.uniforms.steps.value=a,this.mesh.scale.set(this.geoScale,this.geoScale,this.geoScale),this.#n(),this.#i()}update(e,t,n,r){this.mesh.material.uniforms.cameraPos.value.copy(r),this.mesh.position.z+=e*t,this.mesh.position.z>this.spread/2+this.geoScale&&(this.#n(),this.#i());let s=Ws.hsvToRgb([this.#t%360,1,1]);this.mesh.material.uniforms.base.value.setRGB(s[0],s[1],s[2]),this.mesh.material.uniforms.frame.value++,this.#t+=e*n}#n(){const e=(Math.random()-.5)*this.spread,t=(Math.random()-.5)*this.spread,n=-1*this.spread*this.#e/2;this.mesh.position.set(e,t,n)}#i(){const e=Math.random()*Math.PI*2,t=Math.random()*Math.PI*2,n=Math.random()*Math.PI*2;this.mesh.rotation.set(e,t,n)}static hsvToRgb(e){let t;const n=e[0]/60,r=e[1]*e[2],s=r*(1-Math.abs(n%2-1)),a=e[2]-r;return n<0||n>6?t=[0,0,0]:n<1?t=[r,s,0]:n<2?t=[s,r,0]:n<3?t=[0,r,s]:n<4?t=[0,s,r]:n<5?t=[s,0,r]:t=[r,0,s],t[0]+=a,t[1]+=a,t[2]+=a,t}}const Xd=`
...
`,qd=`
				...
				`;/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||Yd();function Yd(){const i=new Gd({antialias:!0});i.setSize(window.innerWidth,window.innerHeight),i.setAnimationLoop(v),i.domElement.id="three-canvas-background",document.body.appendChild(i.domElement);const e=new Xl,t=new Lt(45,window.innerWidth/window.innerHeight,.1,1e3),n=new F(0,0,80);t.position.set(n.x,n.y,n.z),t.lookAt(0,0,0);let r={x:0,y:0};const s=new nc(5592405,.1);e.add(s),e.fog=new Gs(0,.1,160),e.background=new Be(e.fog.color);let a=[];const o=3,l=120;for(let x=0;x<o;x++){const p=new Ws(80,l,.45,.45,.33,10),u=(x-(o-1)/2)*l;p.mesh.position.set(p.mesh.position.x,p.mesh.position.y,u),e.add(p.mesh),a.push(p)}const c=5,h=new kd(100,2*(n.z+c),3);e.add(h.points);const f=new rc,d=25,m=4;function v(){const x=Math.min(f.getDelta(),.03333333333333333),p=2.5,u=new F(r.x*p,r.y*p,0);t.lookAt(u),h.update(x,d,t.position);for(let b=0;b<a.length;b++)a[b].update(x,d,m,t.position);i.render(e,t)}window.addEventListener("resize",function(){t.aspect=window.innerWidth/window.innerHeight,t.updateProjectionMatrix(),i.setSize(window.innerWidth,window.innerHeight)}),window.addEventListener("mousemove",x=>{r.x=x.clientX/window.innerWidth*2-1,r.y=-(x.clientY/window.innerHeight)*2+1})}
